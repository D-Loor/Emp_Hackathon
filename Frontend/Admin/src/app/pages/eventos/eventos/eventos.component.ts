...
export class EventosComponent implements OnInit {
  ...
  editar(id,evento,fecha1,fecha2,estado,imagen){
    ...
    this.estado=estado;
    this.url="http://127.0.0.1:8000/imagenes/"+imagen;
  ...
  public onSelectFile(event) { // called each time file input changes
    if (event.target.files && event.target.files[0]) {
      ...
      if( tipoImagen == "image/jpg"  ||tipoImagen == "image/jpeg"  || tipoImagen == "image/png" || tipoImagen == "image/svg"){
